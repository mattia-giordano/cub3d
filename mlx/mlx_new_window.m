...
void *mlx_new_window(mlx_ptr_t *mlx_ptr, int size_x, int size_y, char *title)
{
  ...
  int max_width = CGDisplayPixelsWide(mainID);
  int max_height = CGDisplayPixelsHigh(mainID);
  NSRect windowRect = NSMakeRect(max_width / 2 - size_x / 2, max_height / 2 - size_y / 2, size_x, size_y);
